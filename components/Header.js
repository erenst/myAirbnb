...
import { MagnifyingGlassIcon,Bars3Icon,UserCircleIcon,GlobeAltIcon,UsersIcon } from "@heroicons/react/24/solid";
        ...
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10 md:shadow-sm">
            ...
            <div className="flex items-center md:border-2 rounded-full py-2">
                ...
                <MagnifyingGlassIcon className="hidden md:inline-flex h-8 
                    bg-red-400 text-white rounded-full p-1 cursor-pointer md:mx-2" />
            </div>
            {/*right */}
